...
const newsBase = [
  ...
  },
  {
    ...
    image: 'ERA_CMS_IMG_13_1785934665.jpg',
    body: {
      az: [
        'Azərbaycan Respublikası Kənd Təsərrüfatı Nazirliyi sərgilərə təşkilati dəstək göstərir. Eyni zamanda, “Caspian Agro Week” və “InterFood Azerbaijan” sərgiləri Azərbaycan Respublikasının Qida Təhlükəsizliyi Agentliyi (AQTA), Azərbaycan Respublikasının Kiçik və Orta Biznesin İnkişafı Agentliyi (KOBİA), Azərbaycan Respublikasının İxracın və İnvestisiyaların Təşviqi Agentliyi (AZPROMO), Azərbaycan Respublikası Sahibkarlar (İşəgötürənlər) Təşkilatları Milli Konfederasiyası (ASK), Azərbaycan Qida və İçki Sənayeçiləri Assosiasiyası (AQİSA), BMT-nin Ərzaq və Kənd Təsərrüfatı Təşkilatı (FAO) və Azərbaycan Sərgi Təşkilatçıları Assosiasiyası (ASTA) tərəfindən dəstəklənir.',
        'Sərgilərdə dünyanın 45 ölkəsindən 447 şirkət iştirak edir.',
        'Tədbirlər 8 may tarixinə qədər davam edəcək.',
      ],
      en: [
        'The Ministry of Agriculture of the Republic of Azerbaijan provides organisational support to the exhibitions. The events are also supported by the Food Safety Agency of the Republic of Azerbaijan (AQTA), the Small and Medium Business Development Agency (KOBİA) of the Republic of Azerbaijan, the Export and Investment Promotion Agency of the Republic of Azerbaijan - AZPROMO, the National Confederation of Entrepreneurs (Employers) Organisations of the Republic of Azerbaijan (ASK), Azerbaijan Food and Beverage Industrialists Association (AQİSA), Food and Agriculture Organisation of the United Nations (FAO), and Azerbaijan Exhibition Organisers Association (ASTA).',
        '447 companies from 45 countries around the world have confirmed their participation in the exhibitions which will be held till May 8.',
      ],
      ru: [
        'Выставки проходят при организационной поддержке Министерства сельского хозяйства Азербайджанской Республики, а также при поддержке Агентства продовольственной безопасности Азербайджанской Республики (AQTA), Агентства развития малого и среднего бизнеса Азербайджанской Республики (KOBİA), Агентства Поощрения Экспорта и Инвестиций Азербайджанской Республики - AZPROMO, Национальной Конфедерации Организаций Предпринимателей (Работодателей) Азербайджанской Республики (ASK), Азербайджанской ассоциации промышленников продуктов питания и напитков (AQİSA), Продовольственной и сельскохозяйственной организации ООН (FAO) и Ассоциации Организаторов Выставок Азербайджана (ASTA).',
        'В мероприятиях принимают участие 447 компаний из 45 стран мира.',
        'Выставки продолжат свою работу до 8 мая.',
      ],
    },
  },
...
const newsCopy = {
  az: [
    ...
    ['5 may tarixində Bakı Ekspo Mərkəzində 19-cu Azərbaycan Beynəlxalq Kənd Təsərrüfatı Sərgi və Forumu - Caspian Agro Week və 31-ci Azərbaycan Beynəlxalq Qida Sənayesi Sərgisi - InterFood Azerbaijan sərgilərinin rəsmi açılış mərasimi keçirilmişdir.', 'Sərgiləri Azərbaycan Respublikasının Prezidenti İlham Əliyev, Birinci xanım Mehriban Əliyeva və Heydər Əliyev Fondunun vitse-prezidenti Leyla Əliyeva ziyarət etmişlər.'],
  ...
  en: [
    ...
    ['On 5 May, the official opening ceremony of the 19th Azerbaijan International Agriculture Exhibition and Forum - Caspian Agro Week and the 31st Azerbaijan International Food Industry Exhibition - InterFood Azerbaijan took place at the Baku Expo Center.', 'The President of the Republic of Azerbaijan, Ilham Aliyev, First Lady Mehriban Aliyeva, and Vice-President of the Heydar Aliyev Foundation, Leyla Aliyeva, visited the exhibitions.'],
  ...
  ru: [
    ...
    ['5 мая в Баку Экспо Центре состоялась официальная церемония открытия 19-й Азербайджанской международной выставки и форума сельского хозяйства Caspian Agro Week и 31-й Азербайджанской международной выставки пищевой промышленности InterFood Azerbaijan', 'Выставки посетили президент Азербайджанской Республики Ильхам Алиев, Первая леди Мехрибан Алиева и вице-президент Фонда Гейдара Алиева Лейла Алиева.'],
